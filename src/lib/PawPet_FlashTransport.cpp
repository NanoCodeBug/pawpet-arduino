...
PawPet_FlashTransport_SPI::PawPet_FlashTransport_SPI(
...
PawPet_FlashTransport_SPI::PawPet_FlashTransport_SPI(uint8_t ss,
...
bool PawPet_FlashTransport_SPI::readCommand(uint8_t command,
...
bool PawPet_FlashTransport_SPI::writeCommand(uint8_t command,
                                               uint8_t const *data,
                                               uint32_t len) {
  beginTransaction(_clock_wr);
...
bool PawPet_FlashTransport_SPI::readMemory(uint32_t addr, uint8_t *data,
                                             uint32_t len) {
  beginTransaction(_clock_rd);
...
bool PawPet_FlashTransport_SPI::writeMemory(uint32_t addr,
                                              uint8_t const *data,
                                              uint32_t len) {
  beginTransaction(_clock_wr);
